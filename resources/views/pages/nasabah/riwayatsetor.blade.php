                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered align-middle">
                                    ...
                                    <tbody id="transaksiTbody" class="text-center"></tbody>
                                </table>
                            </div>
                            
                            <div class="mt-3 text-end">
                                <h5><strong>Total Saldo:</strong> <span id="totalSaldo" class="fw-bold text-success">Rp 0</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function cekDanTambahkanContohData() {
        ...
        if (transaksi.length === 0) {
            let contohData = [
                { tanggal: "2025-03-10", jenis: "Plastik", berat: 2, nilaiTukar: 5000, saldo: 10000 },
                { tanggal: "2025-03-12", jenis: "Kertas", berat: 3, nilaiTukar: 4000, saldo: 12000 },
                { tanggal: "2025-03-15", jenis: "Logam", berat: 1.5, nilaiTukar: 7000, saldo: 10500 },
                { tanggal: "2025-03-18", jenis: "Organik", berat: 4, nilaiTukar: 2000, saldo: 8000 }
            ];
